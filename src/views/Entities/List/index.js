  ...
  if (loading)
    return (
      <div className="flex flex-1 justify-center text-5xl overflow-hidden">
        <Spinner className="text-indigo-600 mt-16" />
      </div>
    );
  return (
    <div className="align-middle inline-block min-w-full overflow-hidden rounded-md shadow-sm sm:rounded-lg border border-gray-300">
      <table className="min-w-full bg-white">
        <thead>
          <tr>
            <th className="bg-gray-50 border-b border-gray-200 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider ">
              <div className="relative px-6 py-3">Nombre</div>
            </th>
